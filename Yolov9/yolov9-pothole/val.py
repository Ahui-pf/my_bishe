...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco-pothole.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp/weights/yolov9-s-converted.pt', help='model path(s)')
